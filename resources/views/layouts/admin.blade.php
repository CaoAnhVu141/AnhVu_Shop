...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="#">Cao Anh Vũ(Xanh chín 1:1)</a></div>
            <div class="nav-right ">
                <div class="btn-group mr-auto">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{url('admin/oder/list') }}">Thêm đơn hàng</a>
                    </div>
                </div>
                <div class="btn-group">
            ...
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link">
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{url('admin/add/post')}}">Thêm mới</a></li>
